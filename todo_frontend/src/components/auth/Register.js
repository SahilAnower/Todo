        ...
        <div>
          ...
          <form onSubmit={register} className={styles.form}>
            <label htmlFor="name" className={styles.label}>
              Name
              <input type="name" name="name" placeholder="name" onChange={inputHandler} value={user.name} required />
            </label>
            ...
            <Button type="button" text="🔀Already Registered? Login!" onClick={()=> toggleHandler()}/>
          </form>
        </div>
      );
}
